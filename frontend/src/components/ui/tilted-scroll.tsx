        ...
        <div className="grid h-[250px] w-[300px] gap-5 animate-skew-scroll grid-cols-1">
          {items.map((item) => (
            ...
            >
              ...
              <TextShimmer 
                className="text-foreground/80 transition-colors group-hover:text-foreground font-medium"
                duration={1.5}
              >
                {item.text}
              </TextShimmer>
...
const defaultItems: TiltedScrollItem[] = [
  { id: "1", text: "Analyzing video content..." },
  { id: "2", text: "Extracting key moments..." },
  { id: "3", text: "Generating thumbnails..." }
]